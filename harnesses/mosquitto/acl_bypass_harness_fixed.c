/*
 * acl_bypass_harness_fixed.c
 * Verificacao do fix de CVE-2017-7650 (commit 9af3c695, v1.4.12).
 *
 * Identico ao acl_bypass_harness.c, exceto que mosquitto_acl_check_default
 * inclui as checagens de strpbrk(...,"+#/") sobre username e id antes do
 * loop de patterns. Espera-se VERIFICATION SUCCESSFUL.
 *
